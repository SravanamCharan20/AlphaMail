export const triageTools = [
  {
    name: "search_emails",
    description:
      "Search the user's synced email summaries using a semantic query and optional filters like account, date range, and tags. Use this when you need a shortlist of relevant threads.",
    parameters: {
      type: "object",
      properties: {
        query: {
  ...
  },
  {
    name: "get_thread",
    description:
      "Fetch the full details of a specific email thread, including messages and cleaned text content. Use this after search when you need deeper context before answering.",
    parameters: {
      type: "object",
      properties: {
        threadId: {
